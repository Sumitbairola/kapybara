  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      toast.success("Post created successfully!", {
        description: `Your post has been ${status === "published" ? "published" : "saved as draft"}.`,
      });
      router.push("/blog");
    } catch (error) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <label
                    ...
                    `}
                  >
                    <RadioGroupItem value="published" className="flex-shrink-0" />
                    <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            ...
            <Button
              ...
              className="w-full sm:w-auto order-1 sm:order-2 bg-blue-600 hover:bg-blue-700 text-white shadow-lg"
            >
